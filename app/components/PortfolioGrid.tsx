...
const projects = [
  {
    ...
    title: 'ePostersLive',
    description:
      'Digital poster platform for scientific conferences with real-time interaction capabilities.',
  ...
  },
  {
    ...
    title: 'InstaJudge',
    description:
      'Streamlined judging system for scientific competitions and research awards.',
  ...
  },
  {
    ...
    title: 'ThrombUS+',
    description:
      'Advanced medical imaging analysis software for cardiovascular research and diagnostics.',
  ...
  },
  {
    ...
    description:
      'Comprehensive platform for academic poster creation, sharing, and archiving.',
  ...
  },
  {
    ...
    description:
      'Intelligent scheduling system for complex research projects and clinical trials.',
  ...
  },
  {
    ...
    description:
      'Bespoke scientific software development tailored to your specific research needs.',
    imageUrl: 'custom.png',
              ...
              >
                {project.url !== null ? (
                  <a
                    ...
                    rel={
                      project.url.startsWith('/#') ? '' : 'noopener noreferrer'
                    }
                    onClick={(e) =>
                      project.url?.startsWith('/#') &&
                      handleInternalLink(e, project.url)
                    }
