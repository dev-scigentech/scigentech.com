...
const timelineEvents = [
  {
    ...
    description:
      'Established in June 2008 to develop specialized scientific poster software for conferences.',
    details:
  ...
  },
  {
    ...
    description:
      'Released our first flagship product for scientific poster creation and presentation.',
    details:
  ...
  },
  {
    ...
    description:
      'PosterGenius won 2nd place at the Eclipse Community Awards in California.',
    details:
  ...
  },
  {
    ...
    description:
      "SciGen's innovative technologies were highlighted in the renowned scientific journal.",
    details:
  ...
  },
  {
    ...
    description:
      'Introduced our comprehensive solution for digital scientific poster management.',
    details:
  ...
  },
  {
    ...
    description:
      'Reached the milestone of supporting 600+ scientific conferences worldwide.',
    details:
  ...
  },
  {
    ...
    description:
      'Expanded into medical imaging analysis with the ThrombUS+ project.',
    details:
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='mt-4 text-lg text-muted-foreground'>
            From pioneering scientific poster software to revolutionizing
